...
Route::get('/admin/voucher/scan', [VoucherScanController::class,
'index'])->name('voucher.scan');

// API Endpoint untuk memvalidasi QR Code
// Dipindahkan dari api.php agar bisa menggunakan session auth ('web')
Route::post('/voucher/redeem', [VoucherRedeemController::class,
'redeem'])->name('voucher.redeem');
});
